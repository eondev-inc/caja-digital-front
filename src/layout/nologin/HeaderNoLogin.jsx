    ...
    >
      ...
      <Navbar.Brand as={Link} to="/" className="flex items-center space-x-3">
        ...
        <div className="flex flex-col">
          <span className="font-heading text-xl font-bold text-secondary-800 dark:text-white">
            {appliedTitle}
          </span>
          <span className="hidden text-xs text-secondary-500 dark:text-neutral-400 sm:block">
            Centros de Salud
          </span>
        </div>
      </Navbar.Brand>
      ...
      <Navbar.Collapse>
        <Navbar.Link
          as={Link}
          to="/"
          className="font-medium text-secondary-700 transition-colors duration-fast hover:text-primary-600 dark:text-neutral-300 dark:hover:text-primary-400"
          active
        >
          Inicio
        </Navbar.Link>
        <Navbar.Link
          ...
          className="cursor-pointer font-medium text-secondary-700 transition-colors duration-fast hover:text-primary-600 dark:text-neutral-300 dark:hover:text-primary-400"
        >
          Características
        </Navbar.Link>
        <Navbar.Link
        ...
        <div className="mt-6 border-t border-neutral-200 pt-4 dark:border-primary-800 sm:hidden">
          <Navbar.Link
            as={Link}
            to="/login"
            className="block w-full py-2 text-center font-medium text-secondary-700 transition-colors duration-fast hover:text-primary-600 dark:text-neutral-300 dark:hover:text-primary-400"
          >
